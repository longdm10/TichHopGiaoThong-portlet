...
denNgay = ParamUtil.getString(request, "denNgay");
	...
	if(((maritimeCode != null) && (maritimeCode.trim() != "")) && ((tuNgay != null) && (tuNgay.trim() != "")) && 
		...
		action.actionExportThongKeTinhHinhNopHoSo(reportDate, maritimeCode, tuNgay, denNgay);
	}
	...
	String tenFileExport1 = BaoCaoConstant.BAO_CAO_THONG_KE_TINH_HINH_NOP_HS_EXPORT;
