...
/**
 * The utility for the monitor message queue local service. This utility wraps {@link vn.dao.gt.asw.service.impl.MonitorMessageQueueLocalServiceImpl} and is the primary access point for service operations in application layer code running on the local server.
 *
 * <p>
...
public class MonitorMessageQueueLocalServiceUtil {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this class directly. Add custom service methods to {@link vn.dao.gt.asw.service.impl.MonitorMessageQueueLocalServiceImpl} and rerun ServiceBuilder to regenerate this class.
	 */
	...
	*/
	public static vn.dao.gt.asw.model.MonitorMessageQueue addMonitorMessageQueue(
	...
	*/
	public static vn.dao.gt.asw.model.MonitorMessageQueue createMonitorMessageQueue(
		long id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteMonitorMessageQueue(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
		getService().deleteMonitorMessageQueue(id);
	}
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteMonitorMessageQueue(
		vn.dao.gt.asw.model.MonitorMessageQueue monitorMessageQueue)
		throws com.liferay.portal.kernel.exception.SystemException {
		getService().deleteMonitorMessageQueue(monitorMessageQueue);
	}
	...
	*/
	...
	public static vn.dao.gt.asw.model.MonitorMessageQueue fetchMonitorMessageQueue(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dao.gt.asw.model.MonitorMessageQueue getMonitorMessageQueue(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.dao.gt.asw.model.MonitorMessageQueue> getMonitorMessageQueues(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.dao.gt.asw.model.MonitorMessageQueue updateMonitorMessageQueue(
		vn.dao.gt.asw.model.MonitorMessageQueue monitorMessageQueue)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	public static vn.dao.gt.asw.model.MonitorMessageQueue updateMonitorMessageQueue(
		...
		boolean merge)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService().updateMonitorMessageQueue(monitorMessageQueue, merge);
	}
	...
	*/
	...
	public static MonitorMessageQueueLocalService getService() {
		if (_service == null) {
			...
			_service = new MonitorMessageQueueLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(MonitorMessageQueueLocalServiceUtil.class,
				"_service");
			MethodCache.remove(MonitorMessageQueueLocalService.class);
		}
