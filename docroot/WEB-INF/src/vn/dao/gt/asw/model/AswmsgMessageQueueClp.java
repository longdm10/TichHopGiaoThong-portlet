...
public class AswmsgMessageQueueClp extends BaseModelImpl<AswmsgMessageQueue>
	...
	public AswmsgMessageQueue toEscapedModel() {
		return (AswmsgMessageQueue)Proxy.newProxyInstance(AswmsgMessageQueue.class.getClassLoader(),
	...
	public boolean equals(Object obj) {
		...
		AswmsgMessageQueueClp aswmsgMessageQueue = null;

		try {
			aswmsgMessageQueue = (AswmsgMessageQueueClp)obj;
		}
