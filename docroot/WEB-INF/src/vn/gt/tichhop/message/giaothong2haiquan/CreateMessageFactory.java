...
public class CreateMessageFactory {
	...
	public static String createMessageAcceptDinhKem(String rejectDesc, String organization, String division, String name, Date rejectDate, TempDocument tempDocument) {
		StringBuilder xmlResult = new StringBuilder("");
		long docname = 0;
		int docyear  = 0;
		...
		System.out.println("=============================createMessageAcceptDinhKem=========== docname " + docname + " docyear " + docyear + " lstresultCertificate.get(0).getMandatory()" + lstresultCertificate.get(0).getMandatory());
		...
		xmlResult.append("<AttachmentList>");
			if(lstresultCertificate != null && lstresultCertificate.size() > 0) {
				...
				xmlResult.append("<AttachmentType>").append("lstresultCertificate NULLL or size <= 0").append("</AttachmentType>");
			}
			
			
//			xmlResult.append("<AttachmentType>").append("01").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("02").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("03").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("04").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("05").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("06").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("07").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("08").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("09").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("10").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("11").append("</AttachmentType>");
//			xmlResult.append("<AttachmentType>").append("12").append("</AttachmentType>");			
		xmlResult.append("</AttachmentList>");		
		xmlResult.append("</RequestAttachment>");
		return xmlResult.toString();
	}
