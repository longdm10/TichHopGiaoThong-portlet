...
public class ReportUtils {
	...
	public void exportBieuMau(ResourceRequest resourceRequest, ResourceResponse resourceResponse,
		...
		try {
			_log.debug("---FILE TEMP ---" + getTemplateReportFilePath(resourceRequest, tenBieuMauTemplate));
