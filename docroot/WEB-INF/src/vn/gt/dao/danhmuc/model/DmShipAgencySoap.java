 ...
 * @generated
 */
public class DmShipAgencySoap implements Serializable {
	public static DmShipAgencySoap toSoapModel(DmShipAgency model) {
		DmShipAgencySoap soapModel = new DmShipAgencySoap();
	...
	public static DmShipAgencySoap[] toSoapModels(DmShipAgency[] models) {
		DmShipAgencySoap[] soapModels = new DmShipAgencySoap[models.length];
	...
	public static DmShipAgencySoap[][] toSoapModels(DmShipAgency[][] models) {
		DmShipAgencySoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmShipAgencySoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmShipAgencySoap[0][0];
		}
	...
	public static DmShipAgencySoap[] toSoapModels(List<DmShipAgency> models) {
		List<DmShipAgencySoap> soapModels = new ArrayList<DmShipAgencySoap>(models.size());

		for (DmShipAgency model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmShipAgencySoap[soapModels.size()]);
	}

	public DmShipAgencySoap() {
	}
