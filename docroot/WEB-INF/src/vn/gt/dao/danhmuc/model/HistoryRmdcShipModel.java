...
/**
 * The base model interface for the HistoryRmdcShip service. Represents a row in the &quot;history_dmdc_ship&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link vn.gt.dao.danhmuc.model.impl.HistoryRmdcShipModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link vn.gt.dao.danhmuc.model.impl.HistoryRmdcShipImpl}.
 * </p>
 *
 * @author win_64
 * @see HistoryRmdcShip
 ...
 * @generated
 */
public interface HistoryRmdcShipModel extends BaseModel<HistoryRmdcShip> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a history rmdc ship model instance should use the {@link HistoryRmdcShip} interface instead.
	 */
