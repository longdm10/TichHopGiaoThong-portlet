 ...
 * @generated
 */
public class DmPortRegionSoap implements Serializable {
	public static DmPortRegionSoap toSoapModel(DmPortRegion model) {
		DmPortRegionSoap soapModel = new DmPortRegionSoap();
	...
	public static DmPortRegionSoap[] toSoapModels(DmPortRegion[] models) {
		DmPortRegionSoap[] soapModels = new DmPortRegionSoap[models.length];
	...
	public static DmPortRegionSoap[][] toSoapModels(DmPortRegion[][] models) {
		DmPortRegionSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmPortRegionSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmPortRegionSoap[0][0];
		}
	...
	public static DmPortRegionSoap[] toSoapModels(List<DmPortRegion> models) {
		List<DmPortRegionSoap> soapModels = new ArrayList<DmPortRegionSoap>(models.size());

		for (DmPortRegion model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmPortRegionSoap[soapModels.size()]);
	}

	public DmPortRegionSoap() {
	}
