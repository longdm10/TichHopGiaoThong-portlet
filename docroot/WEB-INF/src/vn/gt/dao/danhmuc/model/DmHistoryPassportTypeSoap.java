 ...
 * @generated
 */
public class DmHistoryPassportTypeSoap implements Serializable {
	public static DmHistoryPassportTypeSoap toSoapModel(
		DmHistoryPassportType model) {
		DmHistoryPassportTypeSoap soapModel = new DmHistoryPassportTypeSoap();
	...
	public static DmHistoryPassportTypeSoap[] toSoapModels(
		DmHistoryPassportType[] models) {
		DmHistoryPassportTypeSoap[] soapModels = new DmHistoryPassportTypeSoap[models.length];
	...
	public static DmHistoryPassportTypeSoap[][] toSoapModels(
		DmHistoryPassportType[][] models) {
		DmHistoryPassportTypeSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmHistoryPassportTypeSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmHistoryPassportTypeSoap[0][0];
		}
	...
	public static DmHistoryPassportTypeSoap[] toSoapModels(
		List<DmHistoryPassportType> models) {
		List<DmHistoryPassportTypeSoap> soapModels = new ArrayList<DmHistoryPassportTypeSoap>(models.size());

		for (DmHistoryPassportType model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmHistoryPassportTypeSoap[soapModels.size()]);
	}

	public DmHistoryPassportTypeSoap() {
	}
