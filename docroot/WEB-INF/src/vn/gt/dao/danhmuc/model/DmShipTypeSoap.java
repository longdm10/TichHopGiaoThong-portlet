 ...
 * @generated
 */
public class DmShipTypeSoap implements Serializable {
	public static DmShipTypeSoap toSoapModel(DmShipType model) {
		DmShipTypeSoap soapModel = new DmShipTypeSoap();
	...
	public static DmShipTypeSoap[] toSoapModels(DmShipType[] models) {
		DmShipTypeSoap[] soapModels = new DmShipTypeSoap[models.length];
	...
	public static DmShipTypeSoap[][] toSoapModels(DmShipType[][] models) {
		DmShipTypeSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmShipTypeSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmShipTypeSoap[0][0];
		}
	...
	public static DmShipTypeSoap[] toSoapModels(List<DmShipType> models) {
		List<DmShipTypeSoap> soapModels = new ArrayList<DmShipTypeSoap>(models.size());

		for (DmShipType model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmShipTypeSoap[soapModels.size()]);
	}

	public DmShipTypeSoap() {
	}
