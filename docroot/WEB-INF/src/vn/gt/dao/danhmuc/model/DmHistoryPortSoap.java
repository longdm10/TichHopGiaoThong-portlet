 ...
 * @generated
 */
public class DmHistoryPortSoap implements Serializable {
	public static DmHistoryPortSoap toSoapModel(DmHistoryPort model) {
		DmHistoryPortSoap soapModel = new DmHistoryPortSoap();
	...
	public static DmHistoryPortSoap[] toSoapModels(DmHistoryPort[] models) {
		DmHistoryPortSoap[] soapModels = new DmHistoryPortSoap[models.length];
	...
	public static DmHistoryPortSoap[][] toSoapModels(DmHistoryPort[][] models) {
		DmHistoryPortSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmHistoryPortSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmHistoryPortSoap[0][0];
		}
	...
	public static DmHistoryPortSoap[] toSoapModels(List<DmHistoryPort> models) {
		List<DmHistoryPortSoap> soapModels = new ArrayList<DmHistoryPortSoap>(models.size());

		for (DmHistoryPort model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmHistoryPortSoap[soapModels.size()]);
	}

	public DmHistoryPortSoap() {
	}
