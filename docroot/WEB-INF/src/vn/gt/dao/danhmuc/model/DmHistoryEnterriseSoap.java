 ...
 * @generated
 */
public class DmHistoryEnterriseSoap implements Serializable {
	public static DmHistoryEnterriseSoap toSoapModel(DmHistoryEnterrise model) {
		DmHistoryEnterriseSoap soapModel = new DmHistoryEnterriseSoap();
	...
	public static DmHistoryEnterriseSoap[] toSoapModels(
		DmHistoryEnterrise[] models) {
		DmHistoryEnterriseSoap[] soapModels = new DmHistoryEnterriseSoap[models.length];
	...
	public static DmHistoryEnterriseSoap[][] toSoapModels(
		DmHistoryEnterrise[][] models) {
		DmHistoryEnterriseSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmHistoryEnterriseSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmHistoryEnterriseSoap[0][0];
		}
	...
	public static DmHistoryEnterriseSoap[] toSoapModels(
		List<DmHistoryEnterrise> models) {
		List<DmHistoryEnterriseSoap> soapModels = new ArrayList<DmHistoryEnterriseSoap>(models.size());

		for (DmHistoryEnterrise model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmHistoryEnterriseSoap[soapModels.size()]);
	}

	public DmHistoryEnterriseSoap() {
	}
