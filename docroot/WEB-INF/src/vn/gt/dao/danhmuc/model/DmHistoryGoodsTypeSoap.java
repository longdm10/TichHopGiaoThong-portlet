 ...
 * @generated
 */
public class DmHistoryGoodsTypeSoap implements Serializable {
	public static DmHistoryGoodsTypeSoap toSoapModel(DmHistoryGoodsType model) {
		DmHistoryGoodsTypeSoap soapModel = new DmHistoryGoodsTypeSoap();
	...
	public static DmHistoryGoodsTypeSoap[] toSoapModels(
		DmHistoryGoodsType[] models) {
		DmHistoryGoodsTypeSoap[] soapModels = new DmHistoryGoodsTypeSoap[models.length];
	...
	public static DmHistoryGoodsTypeSoap[][] toSoapModels(
		DmHistoryGoodsType[][] models) {
		DmHistoryGoodsTypeSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new DmHistoryGoodsTypeSoap[models.length][models[0].length];
		}
		else {
			soapModels = new DmHistoryGoodsTypeSoap[0][0];
		}
	...
	public static DmHistoryGoodsTypeSoap[] toSoapModels(
		List<DmHistoryGoodsType> models) {
		List<DmHistoryGoodsTypeSoap> soapModels = new ArrayList<DmHistoryGoodsTypeSoap>(models.size());

		for (DmHistoryGoodsType model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new DmHistoryGoodsTypeSoap[soapModels.size()]);
	}

	public DmHistoryGoodsTypeSoap() {
	}
