...
/**
 * This class is used by SOAP remote services, specifically {@link vn.gt.dao.danhmuc.service.http.HistoryRmdcShipServiceSoap}.
 *
 * @author    win_64
 * @see       vn.gt.dao.danhmuc.service.http.HistoryRmdcShipServiceSoap
 * @generated
 */
public class HistoryRmdcShipSoap implements Serializable {
	public static HistoryRmdcShipSoap toSoapModel(HistoryRmdcShip model) {
		HistoryRmdcShipSoap soapModel = new HistoryRmdcShipSoap();
	...
	public static HistoryRmdcShipSoap[] toSoapModels(HistoryRmdcShip[] models) {
		HistoryRmdcShipSoap[] soapModels = new HistoryRmdcShipSoap[models.length];
	...
	public static HistoryRmdcShipSoap[][] toSoapModels(
		HistoryRmdcShip[][] models) {
		HistoryRmdcShipSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new HistoryRmdcShipSoap[models.length][models[0].length];
		}
		else {
			soapModels = new HistoryRmdcShipSoap[0][0];
		}
	...
	public static HistoryRmdcShipSoap[] toSoapModels(
		List<HistoryRmdcShip> models) {
		List<HistoryRmdcShipSoap> soapModels = new ArrayList<HistoryRmdcShipSoap>(models.size());

		for (HistoryRmdcShip model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new HistoryRmdcShipSoap[soapModels.size()]);
	}

	public HistoryRmdcShipSoap() {
	}
