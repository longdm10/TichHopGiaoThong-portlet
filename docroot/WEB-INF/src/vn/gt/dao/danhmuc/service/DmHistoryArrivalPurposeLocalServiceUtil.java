 ...
 * @generated
 */
public class DmHistoryArrivalPurposeLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose addDmHistoryArrivalPurpose(
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose createDmHistoryArrivalPurpose(
		int id) {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose fetchDmHistoryArrivalPurpose(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose getDmHistoryArrivalPurpose(
		int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose> getDmHistoryArrivalPurposes(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose updateDmHistoryArrivalPurpose(
		vn.gt.dao.danhmuc.model.DmHistoryArrivalPurpose dmHistoryArrivalPurpose)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
	...
	*/
	...
	public static DmHistoryArrivalPurposeLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DmHistoryArrivalPurposeLocalService.class.getName());
			...
			_service = new DmHistoryArrivalPurposeLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmHistoryArrivalPurposeLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmHistoryArrivalPurposeLocalService.class);
		}

		return _service;
	}

	public void setService(DmHistoryArrivalPurposeLocalService service) {
		MethodCache.remove(DmHistoryArrivalPurposeLocalService.class);
	...
	private static DmHistoryArrivalPurposeLocalService _service;
}