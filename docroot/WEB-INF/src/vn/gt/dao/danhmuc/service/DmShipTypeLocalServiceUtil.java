 ...
 * @generated
 */
public class DmShipTypeLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmShipType addDmShipType(
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmShipType createDmShipType(int id) {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmShipType fetchDmShipType(int id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmShipType getDmShipType(int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmuc.model.DmShipType> getDmShipTypes(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmShipType updateDmShipType(
		vn.gt.dao.danhmuc.model.DmShipType dmShipType)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmShipType getByShipTypeCode(
	...
	public static DmShipTypeLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DmShipTypeLocalService.class.getName());
			ClassLoader portletClassLoader = (ClassLoader)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					"portletClassLoader");

			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					DmShipTypeLocalService.class.getName(), portletClassLoader);

			_service = new DmShipTypeLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmShipTypeLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmShipTypeLocalService.class);
		}

		return _service;
	}

	public void setService(DmShipTypeLocalService service) {
		MethodCache.remove(DmShipTypeLocalService.class);
	...
	private static DmShipTypeLocalService _service;
}