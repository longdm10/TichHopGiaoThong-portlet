...
import vn.gt.dao.danhmuc.service.base.DmRankRatingLocalServiceBaseImpl;
...
public class DmRankRatingLocalServiceImpl
	extends DmRankRatingLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 ...
	 */
	public vn.gt.dao.danhmuc.model.DmRankRating getByRankCode(String rankCode) {
		try {
			List<vn.gt.dao.danhmuc.model.DmRankRating> dmRankRatinges = dmRankRatingPersistence.findByRankCode(rankCode);
