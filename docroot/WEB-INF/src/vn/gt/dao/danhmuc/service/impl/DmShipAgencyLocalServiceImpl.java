...
import vn.gt.dao.danhmuc.service.base.DmShipAgencyLocalServiceBaseImpl;
...
public class DmShipAgencyLocalServiceImpl
	extends DmShipAgencyLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmShipAgency getByShipAgencyCode(String shipAgencyCode) {
		try {
			List<DmShipAgency> dmShipAgencyCodes = dmShipAgencyPersistence.findByShipAgencyCode(shipAgencyCode);
