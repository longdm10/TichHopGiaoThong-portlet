...
import vn.gt.dao.danhmuc.service.base.DmHistoryShipTypeLocalServiceBaseImpl;
...
public class DmHistoryShipTypeLocalServiceImpl
	extends DmHistoryShipTypeLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryShipType findByShipTypeCodeAndSyncVersion(String shipTypeCode, String syncVersion) {
		try {
			return dmHistoryShipTypePersistence.findByShipTypeCodeAndSyncVersion(shipTypeCode, syncVersion);
