...
import vn.gt.dao.danhmuc.service.base.DmHistoryRankRatingLocalServiceBaseImpl;
...
public class DmHistoryRankRatingLocalServiceImpl
	extends DmHistoryRankRatingLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryRankRating getByRankCodeAndSyncVersion(String rankCode, String syncVersion){
		try {
			return dmHistoryRankRatingPersistence.findByRankCodeAndSyncVersion(rankCode, syncVersion);
