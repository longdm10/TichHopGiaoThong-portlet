 ...
 * @generated
 */
public class DmStateLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmState addDmState(
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmState createDmState(int id) {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static void deleteDmState(vn.gt.dao.danhmuc.model.DmState dmState)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmState fetchDmState(int id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmState getDmState(int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmuc.model.DmState> getDmStates(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmState updateDmState(
		vn.gt.dao.danhmuc.model.DmState dmState)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmState getByStateCode(
		java.lang.String stateCode) {
		return getService().getByStateCode(stateCode);
	}

	public static java.util.List<vn.gt.dao.danhmuc.model.DmState> getAllOrderByName()
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	public static DmStateLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DmStateLocalService.class.getName());
			ClassLoader portletClassLoader = (ClassLoader)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					"portletClassLoader");

			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					DmStateLocalService.class.getName(), portletClassLoader);

			_service = new DmStateLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmStateLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmStateLocalService.class);
		}

		return _service;
	}

	public void setService(DmStateLocalService service) {
		MethodCache.remove(DmStateLocalService.class);
	...
	private static DmStateLocalService _service;
}