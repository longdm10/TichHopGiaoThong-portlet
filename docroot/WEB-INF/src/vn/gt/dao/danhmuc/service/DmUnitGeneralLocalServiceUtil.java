 ...
 * @generated
 */
public class DmUnitGeneralLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmUnitGeneral addDmUnitGeneral(
	...
	*/
	public static vn.gt.dao.danhmuc.model.DmUnitGeneral createDmUnitGeneral(
		int id) {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmUnitGeneral fetchDmUnitGeneral(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmUnitGeneral getDmUnitGeneral(int id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmuc.model.DmUnitGeneral> getDmUnitGenerals(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmuc.model.DmUnitGeneral updateDmUnitGeneral(
		vn.gt.dao.danhmuc.model.DmUnitGeneral dmUnitGeneral)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static vn.gt.dao.danhmuc.model.DmUnitGeneral getByUnitCode(
		java.lang.String unitCode) {
		return getService().getByUnitCode(unitCode);
	}

	public static vn.gt.dao.danhmuc.model.DmUnitGeneral getByUnitCodeAndSyncVersion(
	...
	public static DmUnitGeneralLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DmUnitGeneralLocalService.class.getName());
			...
			_service = new DmUnitGeneralLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmUnitGeneralLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmUnitGeneralLocalService.class);
		}

		return _service;
	}

	public void setService(DmUnitGeneralLocalService service) {
		MethodCache.remove(DmUnitGeneralLocalService.class);
	...
	private static DmUnitGeneralLocalService _service;
}