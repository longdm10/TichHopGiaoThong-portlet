...
import vn.gt.dao.danhmuc.service.base.DmHistoryPortLocalServiceBaseImpl;
...
public class DmHistoryPortLocalServiceImpl
	extends DmHistoryPortLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public vn.gt.dao.danhmuc.model.DmHistoryPort findByPortCodeAndSyncVersion(
		...
		try {
			return dmHistoryPortPersistence.findByPortCodeAndSyncVersion(portCode, syncVersion);
