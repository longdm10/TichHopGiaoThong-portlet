...
import vn.gt.dao.noticeandmessage.service.base.TempHealthQuestionLocalServiceBaseImpl;
...
public class TempHealthQuestionLocalServiceImpl
	extends TempHealthQuestionLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public List<TempHealthQuestion> findByRequestCode(String requestCode) {
		try {
			return tempHealthQuestionPersistence.findByRequestCode(requestCode);
		} catch (Exception e) {
			e.printStackTrace();
		}
		return null;
