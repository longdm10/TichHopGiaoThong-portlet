 ...
 * @generated
 */
public class TempShipSecurityPortItemsLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems addTempShipSecurityPortItems(
	...
	*/
	public static vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems createTempShipSecurityPortItems(
		long id) {
	...
	*/
	...
	public static vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems fetchTempShipSecurityPortItems(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems getTempShipSecurityPortItems(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems> getTempShipSecurityPortItemses(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems updateTempShipSecurityPortItems(
		vn.gt.dao.noticeandmessage.model.TempShipSecurityPortItems tempShipSecurityPortItems)
		throws com.liferay.portal.kernel.exception.SystemException {
		return getService()
	...
	*/
	...
	public static TempShipSecurityPortItemsLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					TempShipSecurityPortItemsLocalService.class.getName());
			...
			_service = new TempShipSecurityPortItemsLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(TempShipSecurityPortItemsLocalServiceUtil.class,
				"_service");
			MethodCache.remove(TempShipSecurityPortItemsLocalService.class);
		}

		return _service;
	}

	public void setService(TempShipSecurityPortItemsLocalService service) {
		MethodCache.remove(TempShipSecurityPortItemsLocalService.class);
	...
	private static TempShipSecurityPortItemsLocalService _service;
}