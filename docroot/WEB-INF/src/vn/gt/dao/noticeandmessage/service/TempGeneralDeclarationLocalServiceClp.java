 ...
 * @author win_64
 */
public class TempGeneralDeclarationLocalServiceClp
	implements TempGeneralDeclarationLocalService {
	public TempGeneralDeclarationLocalServiceClp(
		ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addTempGeneralDeclarationMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addTempGeneralDeclaration",
				vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration.class);

		_createTempGeneralDeclarationMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createTempGeneralDeclaration", long.class);

		_deleteTempGeneralDeclarationMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteTempGeneralDeclaration", long.class);

		_deleteTempGeneralDeclarationMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteTempGeneralDeclaration",
				vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration.class);
		...
		_fetchTempGeneralDeclarationMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"fetchTempGeneralDeclaration", long.class);

		_getTempGeneralDeclarationMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTempGeneralDeclaration", long.class);

		_getPersistedModelMethodKey10 = new MethodKey(_classLoaderProxy.getClassName(),
				"getPersistedModel", java.io.Serializable.class);

		_getTempGeneralDeclarationsMethodKey11 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTempGeneralDeclarations", int.class, int.class);

		_getTempGeneralDeclarationsCountMethodKey12 = new MethodKey(_classLoaderProxy.getClassName(),
				"getTempGeneralDeclarationsCount");

		_updateTempGeneralDeclarationMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateTempGeneralDeclaration",
				vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration.class);

		_updateTempGeneralDeclarationMethodKey14 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateTempGeneralDeclaration",
				vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration.class,
				boolean.class);
		...
		_findTempGeneralDeclarationByRequestCodeMethodKey21 = new MethodKey(_classLoaderProxy.getClassName(),
				"findTempGeneralDeclarationByRequestCode",
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration addTempGeneralDeclaration(
		...
		MethodHandler methodHandler = new MethodHandler(_addTempGeneralDeclarationMethodKey0,
				ClpSerializer.translateInput(tempGeneralDeclaration));
		...
		return (vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration)ClpSerializer.translateOutput(returnObj);
	}
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration createTempGeneralDeclaration(
		...
		MethodHandler methodHandler = new MethodHandler(_createTempGeneralDeclarationMethodKey1,
				id);
	...
	public void deleteTempGeneralDeclaration(long id)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteTempGeneralDeclarationMethodKey2,
				id);
	...
	public void deleteTempGeneralDeclaration(
		vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration tempGeneralDeclaration)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteTempGeneralDeclarationMethodKey3,
				ClpSerializer.translateInput(tempGeneralDeclaration));
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration fetchTempGeneralDeclaration(
		...
		MethodHandler methodHandler = new MethodHandler(_fetchTempGeneralDeclarationMethodKey8,
				id);
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration getTempGeneralDeclaration(
		...
		MethodHandler methodHandler = new MethodHandler(_getTempGeneralDeclarationMethodKey9,
				id);
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration> getTempGeneralDeclarations(
		...
		MethodHandler methodHandler = new MethodHandler(_getTempGeneralDeclarationsMethodKey11,
				start, end);
		...
		return (java.util.List<vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration>)ClpSerializer.translateOutput(returnObj);
	}
	...
	public int getTempGeneralDeclarationsCount()
		...
		MethodHandler methodHandler = new MethodHandler(_getTempGeneralDeclarationsCountMethodKey12);
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration updateTempGeneralDeclaration(
		...
		MethodHandler methodHandler = new MethodHandler(_updateTempGeneralDeclarationMethodKey13,
				ClpSerializer.translateInput(tempGeneralDeclaration));
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration updateTempGeneralDeclaration(
		...
		MethodHandler methodHandler = new MethodHandler(_updateTempGeneralDeclarationMethodKey14,
				ClpSerializer.translateInput(tempGeneralDeclaration), merge);
	...
	public vn.gt.dao.noticeandmessage.model.TempGeneralDeclaration findTempGeneralDeclarationByRequestCode(
		...
		MethodHandler methodHandler = new MethodHandler(_findTempGeneralDeclarationByRequestCodeMethodKey21,
				ClpSerializer.translateInput(requestCode));
	...
	private MethodKey _addTempGeneralDeclarationMethodKey0;
	private MethodKey _createTempGeneralDeclarationMethodKey1;
	private MethodKey _deleteTempGeneralDeclarationMethodKey2;
	private MethodKey _deleteTempGeneralDeclarationMethodKey3;
	private MethodKey _dynamicQueryMethodKey4;
	private MethodKey _dynamicQueryMethodKey5;
	private MethodKey _dynamicQueryMethodKey6;
	private MethodKey _dynamicQueryCountMethodKey7;
	private MethodKey _fetchTempGeneralDeclarationMethodKey8;
	private MethodKey _getTempGeneralDeclarationMethodKey9;
	private MethodKey _getPersistedModelMethodKey10;
	private MethodKey _getTempGeneralDeclarationsMethodKey11;
	private MethodKey _getTempGeneralDeclarationsCountMethodKey12;
	private MethodKey _updateTempGeneralDeclarationMethodKey13;
	private MethodKey _updateTempGeneralDeclarationMethodKey14;
	...
	private MethodKey _findTempGeneralDeclarationByRequestCodeMethodKey21;
