...
/**
 * <p>
 * This class is a wrapper for {@link TempPlantQuarantineLocalService}.
 * </p>
 *
 * @author    win_64
...
public class TempPlantQuarantineLocalServiceWrapper
	...
	*/
	public void deleteTempPlantQuarantine(long id)
		...
		_tempPlantQuarantineLocalService.deleteTempPlantQuarantine(id);
	}
	...
	*/
	public void deleteTempPlantQuarantine(
		vn.gt.dao.noticeandmessage.model.TempPlantQuarantine tempPlantQuarantine)
		throws com.liferay.portal.kernel.exception.SystemException {
		_tempPlantQuarantineLocalService.deleteTempPlantQuarantine(tempPlantQuarantine);
	}
	...
	*/
	...
	public int countBydocumentNameAnddocumentYear(long documentName,
		int documentYear) {
		return _tempPlantQuarantineLocalService.countBydocumentNameAnddocumentYear(documentName,
			documentYear);
	}

	public java.util.List<vn.gt.dao.noticeandmessage.model.TempPlantQuarantine> findBydocumentNameAnddocumentYear(
		long documentName, int documentYear) {
		return _tempPlantQuarantineLocalService.findBydocumentNameAnddocumentYear(documentName,
			documentYear);
	}
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempPlantQuarantine> findBydocumentNameAnddocumentYearRequestState(
		...
		return _tempPlantQuarantineLocalService.findBydocumentNameAnddocumentYearRequestState(documentName,
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempPlantQuarantine> findByRequestCode(
		...
		throws com.liferay.portal.kernel.exception.SystemException {
		return _tempPlantQuarantineLocalService.findByRequestCode(requestCode);
	}
	...
	public vn.gt.dao.noticeandmessage.model.TempPlantQuarantine getLastByDocumentNameAndDocumentYear(
		long documentName, int documentYear) {
		return _tempPlantQuarantineLocalService.getLastByDocumentNameAndDocumentYear(documentName,
			documentYear);
	}
	...
	public java.util.List<vn.gt.dao.noticeandmessage.model.TempPlantQuarantine> findByDocumentNameAndDocumentYearOrderByDescRequestDate(
		long documentName, int documentYear) {
		return _tempPlantQuarantineLocalService.findByDocumentNameAndDocumentYearOrderByDescRequestDate(documentName,
			documentYear);
	}
