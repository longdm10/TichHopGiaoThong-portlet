...
import vn.gt.dao.noticeandmessage.service.base.TempHealthCrewPassengerListLocalServiceBaseImpl;
...
public class TempHealthCrewPassengerListLocalServiceImpl
	extends TempHealthCrewPassengerListLocalServiceBaseImpl {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public List<TempHealthCrewPassengerList> findByRequestCode(String requestCode) {
		try {
			return tempHealthCrewPassengerListPersistence.findByRequestCode(requestCode);
