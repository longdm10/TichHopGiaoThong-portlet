...
import vn.gt.dao.noticeandmessage.service.base.TempShipSecurityPortItemsLocalServiceBaseImpl;
 ...
 */
public class TempShipSecurityPortItemsLocalServiceImpl extends TempShipSecurityPortItemsLocalServiceBaseImpl {
	/*
	...
	public List<TempShipSecurityPortItems> findByRequestCode(String requestCode) throws SystemException {
		return tempShipSecurityPortItemsPersistence.findByRequestCode(requestCode);
	}
	
	public List<TempShipSecurityPortItems> findByRequestCodeOrderByDateArrivalASC(String requestCode) throws SystemException {
		return tempShipSecurityPortItemsFinder.findByRequestCodeOrderByDateArrivalASC(requestCode);
	}
}