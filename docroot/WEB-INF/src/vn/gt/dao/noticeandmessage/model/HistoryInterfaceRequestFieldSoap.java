...
/**
 * This class is used by SOAP remote services, specifically {@link vn.gt.dao.noticeandmessage.service.http.HistoryInterfaceRequestFieldServiceSoap}.
 *
 * @author    win_64
 * @see       vn.gt.dao.noticeandmessage.service.http.HistoryInterfaceRequestFieldServiceSoap
 * @generated
 */
public class HistoryInterfaceRequestFieldSoap implements Serializable {
	public static HistoryInterfaceRequestFieldSoap toSoapModel(
		HistoryInterfaceRequestField model) {
		HistoryInterfaceRequestFieldSoap soapModel = new HistoryInterfaceRequestFieldSoap();
	...
	public static HistoryInterfaceRequestFieldSoap[] toSoapModels(
		HistoryInterfaceRequestField[] models) {
		HistoryInterfaceRequestFieldSoap[] soapModels = new HistoryInterfaceRequestFieldSoap[models.length];
	...
	public static HistoryInterfaceRequestFieldSoap[][] toSoapModels(
		HistoryInterfaceRequestField[][] models) {
		HistoryInterfaceRequestFieldSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new HistoryInterfaceRequestFieldSoap[models.length][models[0].length];
		}
		else {
			soapModels = new HistoryInterfaceRequestFieldSoap[0][0];
		}
	...
	public static HistoryInterfaceRequestFieldSoap[] toSoapModels(
		List<HistoryInterfaceRequestField> models) {
		List<HistoryInterfaceRequestFieldSoap> soapModels = new ArrayList<HistoryInterfaceRequestFieldSoap>(models.size());

		for (HistoryInterfaceRequestField model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new HistoryInterfaceRequestFieldSoap[soapModels.size()]);
	}

	public HistoryInterfaceRequestFieldSoap() {
	}
