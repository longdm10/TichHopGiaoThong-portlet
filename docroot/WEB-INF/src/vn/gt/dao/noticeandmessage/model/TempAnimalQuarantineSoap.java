...
/**
 * This class is used by SOAP remote services, specifically {@link vn.gt.dao.noticeandmessage.service.http.TempAnimalQuarantineServiceSoap}.
 *
 * @author    win_64
 * @see       vn.gt.dao.noticeandmessage.service.http.TempAnimalQuarantineServiceSoap
 * @generated
 */
public class TempAnimalQuarantineSoap implements Serializable {
	public static TempAnimalQuarantineSoap toSoapModel(
		TempAnimalQuarantine model) {
		TempAnimalQuarantineSoap soapModel = new TempAnimalQuarantineSoap();
	...
	public static TempAnimalQuarantineSoap[] toSoapModels(
		TempAnimalQuarantine[] models) {
		TempAnimalQuarantineSoap[] soapModels = new TempAnimalQuarantineSoap[models.length];
	...
	public static TempAnimalQuarantineSoap[][] toSoapModels(
		TempAnimalQuarantine[][] models) {
		TempAnimalQuarantineSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new TempAnimalQuarantineSoap[models.length][models[0].length];
		}
		else {
			soapModels = new TempAnimalQuarantineSoap[0][0];
		}
	...
	public static TempAnimalQuarantineSoap[] toSoapModels(
		List<TempAnimalQuarantine> models) {
		List<TempAnimalQuarantineSoap> soapModels = new ArrayList<TempAnimalQuarantineSoap>(models.size());

		for (TempAnimalQuarantine model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new TempAnimalQuarantineSoap[soapModels.size()]);
	}

	public TempAnimalQuarantineSoap() {
	}
