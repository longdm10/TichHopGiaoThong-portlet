...
/**
 * This class is used by SOAP remote services, specifically {@link vn.gt.dao.noticeandmessage.service.http.TempDeclarationForPlantQuarantineServiceSoap}.
 *
 * @author    win_64
 * @see       vn.gt.dao.noticeandmessage.service.http.TempDeclarationForPlantQuarantineServiceSoap
 * @generated
 */
public class TempDeclarationForPlantQuarantineSoap implements Serializable {
	public static TempDeclarationForPlantQuarantineSoap toSoapModel(
		TempDeclarationForPlantQuarantine model) {
		TempDeclarationForPlantQuarantineSoap soapModel = new TempDeclarationForPlantQuarantineSoap();
	...
	public static TempDeclarationForPlantQuarantineSoap[] toSoapModels(
		TempDeclarationForPlantQuarantine[] models) {
		TempDeclarationForPlantQuarantineSoap[] soapModels = new TempDeclarationForPlantQuarantineSoap[models.length];
	...
	public static TempDeclarationForPlantQuarantineSoap[][] toSoapModels(
		TempDeclarationForPlantQuarantine[][] models) {
		TempDeclarationForPlantQuarantineSoap[][] soapModels = null;

		if (models.length > 0) {
			soapModels = new TempDeclarationForPlantQuarantineSoap[models.length][models[0].length];
		}
		else {
			soapModels = new TempDeclarationForPlantQuarantineSoap[0][0];
		}
	...
	public static TempDeclarationForPlantQuarantineSoap[] toSoapModels(
		List<TempDeclarationForPlantQuarantine> models) {
		List<TempDeclarationForPlantQuarantineSoap> soapModels = new ArrayList<TempDeclarationForPlantQuarantineSoap>(models.size());

		for (TempDeclarationForPlantQuarantine model : models) {
			soapModels.add(toSoapModel(model));
		}

		return soapModels.toArray(new TempDeclarationForPlantQuarantineSoap[soapModels.size()]);
	}

	public TempDeclarationForPlantQuarantineSoap() {
	}
