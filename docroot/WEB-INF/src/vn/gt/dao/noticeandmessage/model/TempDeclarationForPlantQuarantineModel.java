...
/**
 * The base model interface for the TempDeclarationForPlantQuarantine service. Represents a row in the &quot;temp_plant_quarantine&quot; database table, with each column mapped to a property of this class.
 *
 * <p>
 * This interface and its corresponding implementation {@link vn.gt.dao.noticeandmessage.model.impl.TempDeclarationForPlantQuarantineModelImpl} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link vn.gt.dao.noticeandmessage.model.impl.TempDeclarationForPlantQuarantineImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public interface TempDeclarationForPlantQuarantineModel extends BaseModel<TempDeclarationForPlantQuarantine> {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this interface directly. All methods that expect a temp declaration for plant quarantine model instance should use the {@link TempDeclarationForPlantQuarantine} interface instead.
	 */
