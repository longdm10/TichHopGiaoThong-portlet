...
/**
 * The base implementation of the dm gt route config local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGtRouteConfigLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGtRouteConfigLocalServiceBaseImpl
	implements DmGtRouteConfigLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmGtRouteConfig addDmGtRouteConfig(DmGtRouteConfig dmGtRouteConfig)
		...
		dmGtRouteConfig = dmGtRouteConfigPersistence.update(dmGtRouteConfig,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmGtRouteConfig);
			}
	...
	public DmGtRouteConfig createDmGtRouteConfig(long id) {
		return dmGtRouteConfigPersistence.create(id);
	}
	...
	public void deleteDmGtRouteConfig(long id)
		...
		DmGtRouteConfig dmGtRouteConfig = dmGtRouteConfigPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGtRouteConfig);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtRouteConfigPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtRouteConfigPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGtRouteConfig fetchDmGtRouteConfig(long id)
		throws SystemException {
		return dmGtRouteConfigPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGtRouteConfig getDmGtRouteConfig(long id)
		throws PortalException, SystemException {
		return dmGtRouteConfigPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGtRouteConfigPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGtRouteConfig> getDmGtRouteConfigs(int start, int end)
		throws SystemException {
		return dmGtRouteConfigPersistence.findAll(start, end);
	}
	...
	public int getDmGtRouteConfigsCount() throws SystemException {
		return dmGtRouteConfigPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGtRouteConfig",
			dmGtRouteConfigLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGtRouteConfig");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGtRouteConfigPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGtRouteConfigLocalServiceBaseImpl.class);
