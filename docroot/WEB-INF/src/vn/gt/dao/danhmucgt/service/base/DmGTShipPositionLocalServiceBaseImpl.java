...
/**
 * The base implementation of the dm g t ship position local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGTShipPositionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGTShipPositionLocalServiceBaseImpl
	implements DmGTShipPositionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmGTShipPosition addDmGTShipPosition(
		...
		dmGTShipPosition = dmGTShipPositionPersistence.update(dmGTShipPosition,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmGTShipPosition);
			}
	...
	public DmGTShipPosition createDmGTShipPosition(long id) {
		return dmGTShipPositionPersistence.create(id);
	}
	...
	public void deleteDmGTShipPosition(long id)
		...
		DmGTShipPosition dmGTShipPosition = dmGTShipPositionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGTShipPosition);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGTShipPositionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGTShipPositionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGTShipPosition fetchDmGTShipPosition(long id)
		throws SystemException {
		return dmGTShipPositionPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGTShipPosition getDmGTShipPosition(long id)
		throws PortalException, SystemException {
		return dmGTShipPositionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGTShipPositionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGTShipPosition> getDmGTShipPositions(int start, int end)
		throws SystemException {
		return dmGTShipPositionPersistence.findAll(start, end);
	}
	...
	public int getDmGTShipPositionsCount() throws SystemException {
		return dmGTShipPositionPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGTShipPosition",
			dmGTShipPositionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGTShipPosition");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGTShipPositionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGTShipPositionLocalServiceBaseImpl.class);
