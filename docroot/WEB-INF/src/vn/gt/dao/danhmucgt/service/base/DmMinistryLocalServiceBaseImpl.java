...
/**
 * The base implementation of the dm ministry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmMinistryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmMinistryLocalServiceBaseImpl
	implements DmMinistryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmMinistry addDmMinistry(DmMinistry dmMinistry)
		...
		dmMinistry = dmMinistryPersistence.update(dmMinistry, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmMinistry);
			}
	...
	public DmMinistry createDmMinistry(long id) {
		return dmMinistryPersistence.create(id);
	}
	...
	public void deleteDmMinistry(long id)
		...
		DmMinistry dmMinistry = dmMinistryPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmMinistry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmMinistryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmMinistryPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmMinistryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmMinistry fetchDmMinistry(long id) throws SystemException {
		return dmMinistryPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmMinistry getDmMinistry(long id)
		throws PortalException, SystemException {
		return dmMinistryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmMinistryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmMinistry> getDmMinistries(int start, int end)
		throws SystemException {
		return dmMinistryPersistence.findAll(start, end);
	}
	...
	public int getDmMinistriesCount() throws SystemException {
		return dmMinistryPersistence.countAll();
	}
	...
	public DmMinistry updateDmMinistry(DmMinistry dmMinistry, boolean merge)
		...
		dmMinistry = dmMinistryPersistence.update(dmMinistry, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmMinistry",
			dmMinistryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmMinistry");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(DmMinistryLocalServiceBaseImpl.class);
