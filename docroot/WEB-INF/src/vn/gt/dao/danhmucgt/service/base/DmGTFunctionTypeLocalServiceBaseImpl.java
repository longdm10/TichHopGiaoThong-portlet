...
/**
 * The base implementation of the dm g t function type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGTFunctionTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGTFunctionTypeLocalServiceBaseImpl
	implements DmGTFunctionTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmucgt.service.DmGTFunctionTypeLocalServiceUtil} to access the dm g t function type local service.
	 */
	...
	public DmGTFunctionType addDmGTFunctionType(
		...
		dmGTFunctionType = dmGTFunctionTypePersistence.update(dmGTFunctionType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmGTFunctionType);
			}
	...
	public DmGTFunctionType createDmGTFunctionType(long id) {
		return dmGTFunctionTypePersistence.create(id);
	}
	...
	public void deleteDmGTFunctionType(long id)
		...
		DmGTFunctionType dmGTFunctionType = dmGTFunctionTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGTFunctionType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGTFunctionTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGTFunctionTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGTFunctionType fetchDmGTFunctionType(long id)
		throws SystemException {
		return dmGTFunctionTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGTFunctionType getDmGTFunctionType(long id)
		throws PortalException, SystemException {
		return dmGTFunctionTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGTFunctionTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGTFunctionType> getDmGTFunctionTypes(int start, int end)
		throws SystemException {
		return dmGTFunctionTypePersistence.findAll(start, end);
	}
	...
	public int getDmGTFunctionTypesCount() throws SystemException {
		return dmGTFunctionTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGTFunctionType",
			dmGTFunctionTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGTFunctionType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGTFunctionTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGTFunctionTypeLocalServiceBaseImpl.class);
