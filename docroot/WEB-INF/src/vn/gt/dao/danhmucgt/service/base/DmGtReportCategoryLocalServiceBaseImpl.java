...
/**
 * The base implementation of the dm gt report category local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGtReportCategoryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGtReportCategoryLocalServiceBaseImpl
	implements DmGtReportCategoryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmGtReportCategory addDmGtReportCategory(
		...
		dmGtReportCategory = dmGtReportCategoryPersistence.update(dmGtReportCategory,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmGtReportCategory);
			}
	...
	public DmGtReportCategory createDmGtReportCategory(long id) {
		return dmGtReportCategoryPersistence.create(id);
	}
	...
	public void deleteDmGtReportCategory(long id)
		...
		DmGtReportCategory dmGtReportCategory = dmGtReportCategoryPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGtReportCategory);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtReportCategoryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtReportCategoryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGtReportCategory fetchDmGtReportCategory(long id)
		throws SystemException {
		return dmGtReportCategoryPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGtReportCategory getDmGtReportCategory(long id)
		throws PortalException, SystemException {
		return dmGtReportCategoryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGtReportCategoryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGtReportCategory> getDmGtReportCategories(int start, int end)
		throws SystemException {
		return dmGtReportCategoryPersistence.findAll(start, end);
	}
	...
	public int getDmGtReportCategoriesCount() throws SystemException {
		return dmGtReportCategoryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGtReportCategory",
			dmGtReportCategoryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGtReportCategory");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGtReportCategoryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGtReportCategoryLocalServiceBaseImpl.class);
