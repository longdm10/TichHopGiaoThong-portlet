...
/**
 * The base implementation of the dm certificate local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmCertificateLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmCertificateLocalServiceBaseImpl
	implements DmCertificateLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmCertificate addDmCertificate(DmCertificate dmCertificate)
		...
		dmCertificate = dmCertificatePersistence.update(dmCertificate, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmCertificate);
			}
	...
	public DmCertificate createDmCertificate(long id) {
		return dmCertificatePersistence.create(id);
	}
	...
	public void deleteDmCertificate(long id)
		...
		DmCertificate dmCertificate = dmCertificatePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmCertificate);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmCertificatePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmCertificatePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmCertificate fetchDmCertificate(long id) throws SystemException {
		return dmCertificatePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmCertificate getDmCertificate(long id)
		throws PortalException, SystemException {
		return dmCertificatePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmCertificatePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmCertificate> getDmCertificates(int start, int end)
		throws SystemException {
		return dmCertificatePersistence.findAll(start, end);
	}
	...
	public int getDmCertificatesCount() throws SystemException {
		return dmCertificatePersistence.countAll();
	}
	...
	public DmCertificate updateDmCertificate(DmCertificate dmCertificate,
		...
		dmCertificate = dmCertificatePersistence.update(dmCertificate, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmCertificate",
			dmCertificateLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmCertificate");
	}
	...
	private static Log _log = LogFactoryUtil.getLog(DmCertificateLocalServiceBaseImpl.class);
