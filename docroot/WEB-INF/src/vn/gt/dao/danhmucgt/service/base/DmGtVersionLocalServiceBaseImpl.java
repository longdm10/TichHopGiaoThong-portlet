...
/**
 * The base implementation of the dm gt version local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGtVersionLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGtVersionLocalServiceBaseImpl
	implements DmGtVersionLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmGtVersion addDmGtVersion(DmGtVersion dmGtVersion)
		...
		dmGtVersion = dmGtVersionPersistence.update(dmGtVersion, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmGtVersion);
			}
	...
	public DmGtVersion createDmGtVersion(int id) {
		return dmGtVersionPersistence.create(id);
	}
	...
	public void deleteDmGtVersion(int id)
		...
		DmGtVersion dmGtVersion = dmGtVersionPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGtVersion);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtVersionPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmGtVersionPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtVersionPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGtVersion fetchDmGtVersion(int id) throws SystemException {
		return dmGtVersionPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGtVersion getDmGtVersion(int id)
		throws PortalException, SystemException {
		return dmGtVersionPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGtVersionPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGtVersion> getDmGtVersions(int start, int end)
		throws SystemException {
		return dmGtVersionPersistence.findAll(start, end);
	}
	...
	public int getDmGtVersionsCount() throws SystemException {
		return dmGtVersionPersistence.countAll();
	}
	...
	public DmGtVersion updateDmGtVersion(DmGtVersion dmGtVersion, boolean merge)
		...
		dmGtVersion = dmGtVersionPersistence.update(dmGtVersion, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGtVersion",
			dmGtVersionLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGtVersion");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGtVersionPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGtVersionLocalServiceBaseImpl.class);
