...
/**
 * The base implementation of the dm gt status local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGtStatusLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGtStatusLocalServiceBaseImpl
	implements DmGtStatusLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.danhmucgt.service.DmGtStatusLocalServiceUtil} to access the dm gt status local service.
	 */
	...
	public DmGtStatus addDmGtStatus(DmGtStatus dmGtStatus)
		...
		dmGtStatus = dmGtStatusPersistence.update(dmGtStatus, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(dmGtStatus);
			}
	...
	public DmGtStatus createDmGtStatus(long id) {
		return dmGtStatusPersistence.create(id);
	}
	...
	public void deleteDmGtStatus(long id)
		...
		DmGtStatus dmGtStatus = dmGtStatusPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGtStatus);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtStatusPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return dmGtStatusPersistence.findWithDynamicQuery(dynamicQuery, start,
			end);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGtStatusPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGtStatus fetchDmGtStatus(long id) throws SystemException {
		return dmGtStatusPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGtStatus getDmGtStatus(long id)
		throws PortalException, SystemException {
		return dmGtStatusPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGtStatusPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGtStatus> getDmGtStatuses(int start, int end)
		throws SystemException {
		return dmGtStatusPersistence.findAll(start, end);
	}
	...
	public int getDmGtStatusesCount() throws SystemException {
		return dmGtStatusPersistence.countAll();
	}
	...
	public DmGtStatus updateDmGtStatus(DmGtStatus dmGtStatus, boolean merge)
		...
		dmGtStatus = dmGtStatusPersistence.update(dmGtStatus, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGtStatus",
			dmGtStatusLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGtStatus");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGtStatusPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGtStatusLocalServiceBaseImpl.class);
