 ...
 * @generated
 */
public class DmHistoryMinistryLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.danhmucgt.model.DmHistoryMinistry addDmHistoryMinistry(
	...
	*/
	public static vn.gt.dao.danhmucgt.model.DmHistoryMinistry createDmHistoryMinistry(
		long id) {
	...
	*/
	...
	public static vn.gt.dao.danhmucgt.model.DmHistoryMinistry fetchDmHistoryMinistry(
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmucgt.model.DmHistoryMinistry getDmHistoryMinistry(
		long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.danhmucgt.model.DmHistoryMinistry> getDmHistoryMinistries(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmucgt.model.DmHistoryMinistry updateDmHistoryMinistry(
		vn.gt.dao.danhmucgt.model.DmHistoryMinistry dmHistoryMinistry)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*
	* @param dmHistoryMinistry the dm history ministry
	* @param merge whether to merge the dm history ministry with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	* @return the dm history ministry that was updated
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.danhmucgt.model.DmHistoryMinistry updateDmHistoryMinistry(
	...
	*/
	...
	public static DmHistoryMinistryLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					DmHistoryMinistryLocalService.class.getName());
			...
			_service = new DmHistoryMinistryLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(DmHistoryMinistryLocalServiceUtil.class,
				"_service");
			MethodCache.remove(DmHistoryMinistryLocalService.class);
		}

		return _service;
	}

	public void setService(DmHistoryMinistryLocalService service) {
		MethodCache.remove(DmHistoryMinistryLocalService.class);
	...
	private static DmHistoryMinistryLocalService _service;
}