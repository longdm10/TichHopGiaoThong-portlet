...
/**
 * The base implementation of the dm g t business type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmGTBusinessTypeLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmGTBusinessTypeLocalServiceBaseImpl
	implements DmGTBusinessTypeLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmGTBusinessType addDmGTBusinessType(
		...
		dmGTBusinessType = dmGTBusinessTypePersistence.update(dmGTBusinessType,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmGTBusinessType);
			}
	...
	public DmGTBusinessType createDmGTBusinessType(long id) {
		return dmGTBusinessTypePersistence.create(id);
	}
	...
	public void deleteDmGTBusinessType(long id)
		...
		DmGTBusinessType dmGTBusinessType = dmGTBusinessTypePersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmGTBusinessType);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGTBusinessTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmGTBusinessTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmGTBusinessType fetchDmGTBusinessType(long id)
		throws SystemException {
		return dmGTBusinessTypePersistence.fetchByPrimaryKey(id);
	}
	...
	public DmGTBusinessType getDmGTBusinessType(long id)
		throws PortalException, SystemException {
		return dmGTBusinessTypePersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmGTBusinessTypePersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmGTBusinessType> getDmGTBusinessTypes(int start, int end)
		throws SystemException {
		return dmGTBusinessTypePersistence.findAll(start, end);
	}
	...
	public int getDmGTBusinessTypesCount() throws SystemException {
		return dmGTBusinessTypePersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmGTBusinessType",
			dmGTBusinessTypeLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmGTBusinessType");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmGTBusinessTypePersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmGTBusinessTypeLocalServiceBaseImpl.class);
