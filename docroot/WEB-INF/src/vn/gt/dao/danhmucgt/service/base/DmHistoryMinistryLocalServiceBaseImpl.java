...
/**
 * The base implementation of the dm history ministry local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.danhmucgt.service.impl.DmHistoryMinistryLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DmHistoryMinistryLocalServiceBaseImpl
	implements DmHistoryMinistryLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	public DmHistoryMinistry addDmHistoryMinistry(
		...
		dmHistoryMinistry = dmHistoryMinistryPersistence.update(dmHistoryMinistry,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(dmHistoryMinistry);
			}
	...
	public DmHistoryMinistry createDmHistoryMinistry(long id) {
		return dmHistoryMinistryPersistence.create(id);
	}
	...
	public void deleteDmHistoryMinistry(long id)
		...
		DmHistoryMinistry dmHistoryMinistry = dmHistoryMinistryPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(dmHistoryMinistry);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryMinistryPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return dmHistoryMinistryPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DmHistoryMinistry fetchDmHistoryMinistry(long id)
		throws SystemException {
		return dmHistoryMinistryPersistence.fetchByPrimaryKey(id);
	}
	...
	public DmHistoryMinistry getDmHistoryMinistry(long id)
		throws PortalException, SystemException {
		return dmHistoryMinistryPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return dmHistoryMinistryPersistence.findByPrimaryKey(primaryKeyObj);
	}
	...
	public List<DmHistoryMinistry> getDmHistoryMinistries(int start, int end)
		throws SystemException {
		return dmHistoryMinistryPersistence.findAll(start, end);
	}
	...
	public int getDmHistoryMinistriesCount() throws SystemException {
		return dmHistoryMinistryPersistence.countAll();
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.danhmucgt.model.DmHistoryMinistry",
			dmHistoryMinistryLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.danhmucgt.model.DmHistoryMinistry");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = dmHistoryMinistryPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DmHistoryMinistryLocalServiceBaseImpl.class);
