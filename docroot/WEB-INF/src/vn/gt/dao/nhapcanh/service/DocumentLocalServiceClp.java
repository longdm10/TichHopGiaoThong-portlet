...
public class DocumentLocalServiceClp implements DocumentLocalService {
	public DocumentLocalServiceClp(ClassLoaderProxy classLoaderProxy) {
		_classLoaderProxy = classLoaderProxy;

		_addDocumentMethodKey0 = new MethodKey(_classLoaderProxy.getClassName(),
				"addDocument", vn.gt.dao.nhapcanh.model.Document.class);

		_createDocumentMethodKey1 = new MethodKey(_classLoaderProxy.getClassName(),
				"createDocument", long.class);

		_deleteDocumentMethodKey2 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteDocument", long.class);

		_deleteDocumentMethodKey3 = new MethodKey(_classLoaderProxy.getClassName(),
				"deleteDocument", vn.gt.dao.nhapcanh.model.Document.class);
		...
		_fetchDocumentMethodKey8 = new MethodKey(_classLoaderProxy.getClassName(),
				"fetchDocument", long.class);

		_getDocumentMethodKey9 = new MethodKey(_classLoaderProxy.getClassName(),
				"getDocument", long.class);
		...
		_updateDocumentMethodKey13 = new MethodKey(_classLoaderProxy.getClassName(),
				"updateDocument", vn.gt.dao.nhapcanh.model.Document.class);
	...
	public vn.gt.dao.nhapcanh.model.Document addDocument(
		...
		return (vn.gt.dao.nhapcanh.model.Document)ClpSerializer.translateOutput(returnObj);
	}

	public vn.gt.dao.nhapcanh.model.Document createDocument(long id) {
		Object returnObj = null;

		MethodHandler methodHandler = new MethodHandler(_createDocumentMethodKey1,
				id);
	...
	public void deleteDocument(long id)
		...
		MethodHandler methodHandler = new MethodHandler(_deleteDocumentMethodKey2,
				id);
	...
	public void deleteDocument(vn.gt.dao.nhapcanh.model.Document document)
		throws com.liferay.portal.kernel.exception.SystemException {
		MethodHandler methodHandler = new MethodHandler(_deleteDocumentMethodKey3,
				ClpSerializer.translateInput(document));
	...
	public vn.gt.dao.nhapcanh.model.Document fetchDocument(long id)
		...
		MethodHandler methodHandler = new MethodHandler(_fetchDocumentMethodKey8,
				id);
	...
	public vn.gt.dao.nhapcanh.model.Document getDocument(long id)
		...
		MethodHandler methodHandler = new MethodHandler(_getDocumentMethodKey9,
				id);
	...
	public java.util.List<vn.gt.dao.nhapcanh.model.Document> getDocuments(
		...
		return (java.util.List<vn.gt.dao.nhapcanh.model.Document>)ClpSerializer.translateOutput(returnObj);
	}
	...
	private MethodKey _createDocumentMethodKey1;
	private MethodKey _deleteDocumentMethodKey2;
	private MethodKey _deleteDocumentMethodKey3;
