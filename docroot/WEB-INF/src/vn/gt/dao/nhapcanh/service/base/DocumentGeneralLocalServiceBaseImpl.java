...
/**
 * The base implementation of the document general local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.nhapcanh.service.impl.DocumentGeneralLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class DocumentGeneralLocalServiceBaseImpl
	implements DocumentGeneralLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.nhapcanh.service.DocumentGeneralLocalServiceUtil} to access the document general local service.
	 */
	...
	public DocumentGeneral addDocumentGeneral(DocumentGeneral documentGeneral)
		...
		documentGeneral = documentGeneralPersistence.update(documentGeneral,
				false);
		...
		if (indexer != null) {
			try {
				indexer.reindex(documentGeneral);
			}
	 ...
	 */
	public DocumentGeneral createDocumentGeneral(long id) {
		return documentGeneralPersistence.create(id);
	}
	...
	public void deleteDocumentGeneral(long id)
		...
		DocumentGeneral documentGeneral = documentGeneralPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(documentGeneral);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDocumentGeneral(DocumentGeneral documentGeneral)
		throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return documentGeneralPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return documentGeneralPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public DocumentGeneral fetchDocumentGeneral(long id)
		throws SystemException {
		return documentGeneralPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DocumentGeneral getDocumentGeneral(long id)
		throws PortalException, SystemException {
		return documentGeneralPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return documentGeneralPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<DocumentGeneral> getDocumentGenerals(int start, int end)
		throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDocumentGeneralsCount() throws SystemException {
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public DocumentGeneral updateDocumentGeneral(
		DocumentGeneral documentGeneral) throws SystemException {
		return updateDocumentGeneral(documentGeneral, true);
	}
	 ...
	 */
	public DocumentGeneral updateDocumentGeneral(
		DocumentGeneral documentGeneral, boolean merge)
		throws SystemException {
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.nhapcanh.model.DocumentGeneral",
			documentGeneralLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.nhapcanh.model.DocumentGeneral");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = documentGeneralPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(DocumentGeneralLocalServiceBaseImpl.class);
