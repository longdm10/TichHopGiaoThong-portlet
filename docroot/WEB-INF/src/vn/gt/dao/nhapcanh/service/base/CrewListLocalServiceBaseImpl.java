...
/**
 * The base implementation of the crew list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.nhapcanh.service.impl.CrewListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class CrewListLocalServiceBaseImpl
	implements CrewListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.nhapcanh.service.CrewListLocalServiceUtil} to access the crew list local service.
	 */
	 ...
	 */
	public CrewList addCrewList(CrewList crewList) throws SystemException {
		crewList.setNew(true);

		crewList = crewListPersistence.update(crewList, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(crewList);
			}
	 ...
	 */
	public CrewList createCrewList(long id) {
		return crewListPersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCrewList(long id) throws PortalException, SystemException {
		CrewList crewList = crewListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(crewList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteCrewList(CrewList crewList) throws SystemException {
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return crewListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return crewListPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return crewListPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return crewListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public CrewList fetchCrewList(long id) throws SystemException {
		return crewListPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CrewList getCrewList(long id)
		throws PortalException, SystemException {
		return crewListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return crewListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<CrewList> getCrewLists(int start, int end)
		throws SystemException {
		return crewListPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getCrewListsCount() throws SystemException {
		return crewListPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CrewList updateCrewList(CrewList crewList) throws SystemException {
		return updateCrewList(crewList, true);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public CrewList updateCrewList(CrewList crewList, boolean merge)
		throws SystemException {
		crewList.setNew(false);

		crewList = crewListPersistence.update(crewList, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.nhapcanh.model.CrewList",
			crewListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.nhapcanh.model.CrewList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = crewListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(CrewListLocalServiceBaseImpl.class);
