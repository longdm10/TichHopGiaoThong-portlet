 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.nhapcanh.service.impl.DocumentLocalServiceImpl}.
 * </p>
 *
 * @author win_64
...
public abstract class DocumentLocalServiceBaseImpl
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.nhapcanh.service.DocumentLocalServiceUtil} to access the document local service.
	 */
	...
	public Document createDocument(long id) {
		return documentPersistence.create(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDocument(long id) throws PortalException, SystemException {
		Document document = documentPersistence.remove(id);
	...
	public Document fetchDocument(long id) throws SystemException {
		return documentPersistence.fetchByPrimaryKey(id);
	}
	...
	public Document getDocument(long id)
		...
		return documentPersistence.findByPrimaryKey(id);
	}
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.nhapcanh.model.Document",
			documentLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.nhapcanh.model.Document");
	}
