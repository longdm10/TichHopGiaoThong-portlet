...
/**
 * The base implementation of the passenger list local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link vn.gt.dao.nhapcanh.service.impl.PassengerListLocalServiceImpl}.
 * </p>
 *
 * @author win_64
 ...
 * @generated
 */
public abstract class PassengerListLocalServiceBaseImpl
	implements PassengerListLocalService, IdentifiableBean {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. Always use {@link vn.gt.dao.nhapcanh.service.PassengerListLocalServiceUtil} to access the passenger list local service.
	 */
	 ...
	 */
	public PassengerList addPassengerList(PassengerList passengerList)
		throws SystemException {
		passengerList.setNew(true);

		passengerList = passengerListPersistence.update(passengerList, false);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.reindex(passengerList);
			}
	 ...
	 */
	public PassengerList createPassengerList(long id) {
		return passengerListPersistence.create(id);
	}
	...
	public void deletePassengerList(long id)
		...
		PassengerList passengerList = passengerListPersistence.remove(id);

		Indexer indexer = IndexerRegistryUtil.getIndexer(getModelClassName());

		if (indexer != null) {
			try {
				indexer.delete(passengerList);
			}
			catch (SearchException se) {
				if (_log.isWarnEnabled()) {
					_log.warn(se, se);
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return passengerListPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return passengerListPersistence.countWithDynamicQuery(dynamicQuery);
	}

	public PassengerList fetchPassengerList(long id) throws SystemException {
		return passengerListPersistence.fetchByPrimaryKey(id);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PassengerList getPassengerList(long id)
		throws PortalException, SystemException {
		return passengerListPersistence.findByPrimaryKey(id);
	}

	public PersistedModel getPersistedModel(Serializable primaryKeyObj)
		throws PortalException, SystemException {
		return passengerListPersistence.findByPrimaryKey(primaryKeyObj);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<PassengerList> getPassengerLists(int start, int end)
		throws SystemException {
		return passengerListPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getPassengerListsCount() throws SystemException {
		return passengerListPersistence.countAll();
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public PassengerList updatePassengerList(PassengerList passengerList)
		throws SystemException {
		return updatePassengerList(passengerList, true);
	}
	...
	public PassengerList updatePassengerList(PassengerList passengerList,
		...
		passengerList = passengerListPersistence.update(passengerList, merge);
	...
	public void afterPropertiesSet() {
		PersistedModelLocalServiceRegistryUtil.register("vn.gt.dao.nhapcanh.model.PassengerList",
			passengerListLocalService);
	}

	public void destroy() {
		PersistedModelLocalServiceRegistryUtil.unregister(
			"vn.gt.dao.nhapcanh.model.PassengerList");
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = passengerListPersistence.getDataSource();
	...
	private static Log _log = LogFactoryUtil.getLog(PassengerListLocalServiceBaseImpl.class);
