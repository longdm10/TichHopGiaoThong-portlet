 ...
 * @generated
 */
public class CrewListLocalServiceUtil {
	/*
	 * NOTE FOR DEVELOPERS:
	 *
	...
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList addCrewList(
	...
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList createCrewList(long id) {
	...
	*/
	...
	public static vn.gt.dao.nhapcanh.model.CrewList fetchCrewList(long id)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList getCrewList(long id)
		throws com.liferay.portal.kernel.exception.PortalException,
			com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static java.util.List<vn.gt.dao.nhapcanh.model.CrewList> getCrewLists(
		int start, int end)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	* @throws SystemException if a system exception occurred
	*/
	public static vn.gt.dao.nhapcanh.model.CrewList updateCrewList(
		vn.gt.dao.nhapcanh.model.CrewList crewList)
		throws com.liferay.portal.kernel.exception.SystemException {
	...
	*/
	...
	public static CrewListLocalService getService() {
		if (_service == null) {
			Object object = PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					CrewListLocalService.class.getName());
			ClassLoader portletClassLoader = (ClassLoader)PortletBeanLocatorUtil.locate(ClpSerializer.getServletContextName(),
					"portletClassLoader");

			ClassLoaderProxy classLoaderProxy = new ClassLoaderProxy(object,
					CrewListLocalService.class.getName(), portletClassLoader);

			_service = new CrewListLocalServiceClp(classLoaderProxy);

			ClpSerializer.setClassLoader(portletClassLoader);

			ReferenceRegistry.registerReference(CrewListLocalServiceUtil.class,
				"_service");
			MethodCache.remove(CrewListLocalService.class);
		}

		return _service;
	}

	public void setService(CrewListLocalService service) {
		MethodCache.remove(CrewListLocalService.class);
	...
	private static CrewListLocalService _service;
}